    ...
    <!-- Primary Navigation Menu -->
            ...
            <div class="grid grid-cols-3 w-full">
                    ...
                    <div class="flex justify-end items-center">
                        <div class="hidden sm:-my-px sm:ml-4 sm:flex justify-end">
                            <x-jet-nav-link href="{{ route('profile', ['user' => auth()->user()->username ]) }}"
                                ...
                                <x-jet-dropdown align="right" width="48">
                                    ...
                                    <button type="button"
                                         ...
                                         <img src=" {{ asset('avatars/'.auth()->user()->avatar) }}"
                                              class="circle border rounded-full w-10 h-10 object-contain">
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-nav-link href="{{ route('profile', ['user' => auth()->user()->id ]) }}"
                                :active="request()->routeIs('profile')">
                    Profile
                </x-jet-nav-link>
            </div>
